...
const SHOTS = [
  { src: "/images/KOSI2067.jpg", cap: "อุโมงป่าจาก",   area: "a" },
  { src: "/images/KOSI4747.jpg", cap: "วัดบางน้อย",    area: "b" },
  { src: "/images/KOSI4714.jpg", cap: "น้ำใส",          area: "c" },
  { src: "/images/KOSI6162.jpg", cap: "กลุ่มเพื่อน",    area: "d" },
  { src: "/images/KOSI6383.jpg", cap: "ผจญภัยริมคลอง", area: "e" },
];

function Cell({ src, cap, area }: { src: string; cap: string; area: string }) {
  ...
  return (
    <div
      ...
      style={{
        gridArea: area, position: "relative", borderRadius: 12, overflow: "hidden",
      ...
      <div className="container">
        ...
        <div
          style={{
            ...
            gridTemplateAreas: `"a a b c" "d e e c"`,
            gap: 14,
          }}
          className="gallery-grid"
        >
          {SHOTS.map((s) => <Cell key={s.area} {...s} />)}
        </div>
      </div>
